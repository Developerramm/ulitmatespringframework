...
public final class BlueDart implements LogisticsService {
	...
	public String orderReturnRequest(int orderId) {
		String returnRequestStatus = "Your order is " + orderId + ""
				+ " A return request is accepted. It will be pick by bluedart agen today";
	...
	public String orderReplaceRequest(int orderId) {
		String replaceStatus = "Your order is " + orderId + ""
				+ " A replace request is accepted. It will be pick by bluedart agen today";
